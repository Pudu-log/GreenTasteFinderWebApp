...
<body>
						...
						<div class="details">
							...
							<div>
								<span><fmt:formatNumber value="${restaurant.distance}"
										type="number" maxFractionDigits="2" /> m</span>
							</div>
						</div>
	...
	<div class="pagination">
		...
		<c:if test="${pagingBtn.prevBtn}">
			<a href="/page/${currentPage - 1}" class="pagination-nav">이전</a>
		</c:if>
		...
		<c:if test="${pagingBtn.nextBtn}">
			<a href="/page/${currentPage + 1}" class="pagination-nav">다음</a>
		</c:if>
	</div>
    ...
    function sortRestaurants() {
        ...
        fetch(`/restaurants?sortBy=${sortBy}`, {
            method: 'GET',
        })
                ...
                restaurantListHtml += `
                    <div class="restaurant">
                        <div class="restaurant-content">
                            <h4>${restaurant.name}</h4>
                            <div class="details">
                                <div><span>⭐ ${restaurant.rating}</span></div>
                                <div><span>${restaurant.distance} m</span></div>
                            </div>
                            <div class="restaurant-info">
                                <p>${restaurant.address}</p>
                                <p>${restaurant.phoneNumber}</p>
                                ...
                                <p><strong>리뷰(${restaurant.reviewCount})</strong></p>
                            </div>
                        </div>

                        <div class="actions">
                            <div class="action-btn ${restaurant.liked ? 'liked' : ''}" onclick="toggleLike(this)">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            ...
                            <div class="action-btn ${restaurant.favorited ? 'favorited' : ''}" onclick="toggleFavorite(this)">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
